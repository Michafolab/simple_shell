...
/**
 * _strcmp - This is the function used to compare two strings.
...
/**
 * _strchr - This should locate the character in a string,
 * @s: string.
 * @c: character.
 * Return: This should return the pointer to the first occurrence of the character c.
 */
